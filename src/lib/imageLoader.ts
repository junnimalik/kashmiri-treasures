...
const shawlImages = import.meta.glob('@/assets/shawls/*.{jpg,jpeg,png,webp,JPG,JPEG,PNG,WEBP}', { eager: true, as: 'url' });
const pheranImages = import.meta.glob('@/assets/pherans/*.{jpg,jpeg,png,webp,JPG,JPEG,PNG,WEBP}', { eager: true, as: 'url' });
const handbagImages = import.meta.glob('@/assets/handbags/*.{jpg,jpeg,png,webp,JPG,JPEG,PNG,WEBP}', { eager: true, as: 'url' });
const dryFruitImages = import.meta.glob('@/assets/dry-fruits/*.{jpg,jpeg,png,webp,JPG,JPEG,PNG,WEBP}', { eager: true, as: 'url' });
const giftHamperImages = import.meta.glob('@/assets/gift-hampers/*.{jpg,jpeg,png,webp,JPG,JPEG,PNG,WEBP}', { eager: true, as: 'url' });
